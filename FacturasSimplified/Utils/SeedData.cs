...
public static class SeedData
{
  public static void Seed(IServiceProvider serviceProvider)
  {
    ...
    if (!context.NcfRanges.Any())
    {
      context.NcfRanges.AddRange(
          new NcfRange { Id = 1, Type = 0, ValidFrom = DateTime.UtcNow, ValidTo = DateTime.UtcNow.AddDays(7), NcfRangeStatus = 0, NumberMin = 400, NumberMax = 500 }
          );
      context.SaveChanges();
    }
    #endregion
